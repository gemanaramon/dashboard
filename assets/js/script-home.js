...
$(document).ready(function () {
      ...
      success: function (rss) {
        ...
        if (rss == 105) {
          ...
          $("#modalWarning .alert").html(
            " You are attempting to log-in beyond your call time. <br> You can no longer log-in via the Dashboard.  <br>  <br> Please obtain clearance from your department head and .  <br> The OGM.  <br>  <br>Thank you.",
          );
          ...
          $("#modalWarning").modal("toggle");
          $("#modalWarning .alert").html(
            "Oops, we couldn't find your Schedule for Today!",
          );
          $("#LoginWarning").modal("toggle");
          //validation for whole day leave and half day leave
        } else if (rss == 1000) {
          $("#modalWarning").modal("toggle");
          $("#modalWarning .alert").html(
          ...
          $("#LoginWarning").modal("toggle");
          $("#LoginEOUnder .lg-question h3").text(
            "Your EO application today is not yet approve. Are you sure you want to Continue?",
          );
          $("#LoginEOUnder .lg-question h4").html(
            "<i class='fa fa-exclamation-triangle' style='color:#e3c80b; margin-right:5px;' aria-hidden='true'></i>By continuing,  you agree to let the system tag your LILO today, as not paid.",
          );
          ...
          $("#LoginWarning").modal("toggle");
          $("#LoginEOUnder .lg-question h3").text(
            "You have a canceled or disapproved Early Out Application and Your Attendance today is not yet complete. Are You sure you want to Logout ?",
          );
          $("#LoginEOUnder .lg-question h4").html(
            "<i class='fa fa-exclamation-triangle' style='color:#e3c80b; margin-right:5px;' aria-hidden='true'></i>By continuing,  you agree to let the system tag your LILO today, as not paid.",
          );
          ...
          $("#LoginWarning").modal("toggle");
          $("#LoginEOUnder .lg-question h3").text(
            "Your Attendance today is not yet complete. Are you sure you want to Continue?",
          );
          $("#LoginEOUnder .lg-question h4").html(
            "<i class='fa fa-exclamation-triangle' style='color:#e3c80b; margin-right:5px;' aria-hidden='true'></i>By continuing,  you agree to let the system tag your LILO today, as not paid.",
          );
  ...
  $(".btnref2").click(function () {
    if ($("#dpfrom").val() == "" || $("#dpto").val() == "") {
      ...
      xmlhttp.open(
        "GET",
        "query/Query-SDarLilo.php?lilo&dtf=" +
          $("#dpfrom").val() +
          "&dtt=" +
          $("#dpto").val(),
        true,
  ...
  $(".btnref").click(function () {
    if ($("#dpfrom").val() == "" || $("#dpto").val() == "") {
      ...
      xmlhttp.open(
        "GET",
        "query/Query-SDarLilo.php?dar&dtf=" +
          $("#dpfrom").val() +
          "&dtt=" +
          $("#dpto").val(),
        true,
