$(document).ready(function () {
  ...
  $(document).on("click", "#saveot", function () {
    if (!$("#otpurpose").val()) {
      ...
      $("#result").html(
        '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong> Input Purpose!'
      );
      $(".alert").show();
      ...
      $("#result").addClass("alert alert-danger offset4 span4");
      $("#result").html(
        '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong> Please Select OT Date From!'
      );
      $(".alert").show();
      $(".alert").css("opacity", "100%");
      $(".alert .close").on("click", function () {
      ...
      $("#result").addClass("alert alert-danger offset4 span4");
      $("#result").html(
        '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong> Please Select OT Date To!'
      );
      $(".alert").show();
      $(".alert").css("opacity", "100%");
      $(".alert .close").on("click", function () {
      ...
      $("#result").addClass("alert alert-danger offset4 span4");
      $("#result").html(
        '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong> Please Select OT Time From!'
      );
      $(".alert").show();
      $(".alert").css("opacity", "100%");
      $(".alert .close").on("click", function () {
      ...
      $("#result").addClass("alert alert-danger offset4 span4");
      $("#result").html(
        '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong> Please Select OT Time To!'
      );
      $(".alert").show();
      $(".alert").css("opacity", "100%");
      $(".alert .close").on("click", function () {
      ...
      $("#result").addClass("alert alert-danger offset4 span4");
      $("#result").html(
        '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong> Invalid Inclusive Date!'
      );
      $(".alert").show();
      $(".alert").css("opacity", "100%");
      $(".alert .close").on("click", function () {
      ...
      $("#result").addClass("alert alert-danger offset4 span4");
      $("#result").html(
        '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong> Invalid Inclusive OT Time!'
      );
      $(".alert").show();
      $(".alert").css("opacity", "100%");
      $(".alert .close").on("click", function () {
    ...
    // }
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          $("#result").html(
            '<button type="button" class="close" aria-label="close">×</button><strong>Message! </strong>' +
              res
          );
          $(".alert").show();
          $(".alert").css("opacity", "100%");
    ...
    if ($("#empname").val() === "") {
      ...
      $.ajax({
        ...
        success: function (xx) {
          ...
          if (xx == 2) {
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert h5").html(
              "Cant file ! Employee already have an OB on this Inclusive Date Time ! "
            );
            $("#return").css("border", "1px solid red");
            return;
          } else if (xx == 3) {
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert h5").html(
              "Cant file ! Employee Inclusive Date Time is not within working time !  "
            );
            $("#return").css("border", "1px solid red");
            return;
          } else if (xx == 4) {
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert h5").html(
              "The OB application must be completed on or before 8:30 AM."
            );
            $("#return").css("border", "1px solid red");
            return;
          } else {
  ...
  $("#leavepay").change(function () {
    if ($(this).val() == 0) {
      ...
      $("#leavetype")
        .children("option[value^=" + $("#leavetype").val("33") + "]")
        .show();
    } else {
      $("#leavetype").val("35");
      $("#leavetype").children("option").show();
  ...
  $("#Ltimeto").change(function () {
    var diff =
      (new Date("1970-1-1 " + $("#Ltimeto").val()) -
        new Date("1970-1-1 " + $("#Ltimefrom").val())) /
      1000 /
      60 /
      60;
    $(".dura").val(diff);
        ...
        success: function (data) {
          ...
          if (data == 2) {
            ...
            $("#modalWarning .alert").html(
              "You have No Schedule on this Date !"
            );
          } else if (data == 3) {
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert").html("Invalid Inclusive Time !");
            ...
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert").html(
              "System not accepting same filing date  !"
            );
          } else if (data == 5) {
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert").html(
              "System not accepting Filing in holiday !"
            );
          } else if (data == 6) {
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert").html(
              "System not accept OB when you are leave !"
            );
          } else if (data == 1) {
            $("#modalWarning").modal("toggle");
            ...
            $("#modalWarning").modal("toggle");
            $("#modalWarning .alert").html(
              "You can't apply OB for this inclusive date. Payroll is already generated! "
            );
          } else {
            $("#modalSuccess").modal("toggle");
            $("#modalSuccess .alert").html("Succesfully Saved");
