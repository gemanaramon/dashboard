...
<head>
    <title>13 Month Attachement</title>
...
<body style="background-image: none">
    ...
    <div class="w-container">
        <div class="row">
            ...
            <div class="col-lg-9 ">
                <h4 class="page-title" style="<?php echo "color: " . $_SESSION['CompanyColor']; ?>">13th Month Attachement</h4>
                <div class="in-con">
                    <br>
                    <div class="row" style="background-color: floralwhite;margin:1px">
                        <div class="col-md-2 pagti">
                            ...
                            <input type="date" class="form-control" id="cutOFd2" value="2024-04-05"  name="cutOFd2" style="margin-bottom: 5px">
                        </div>

                        <div class="col-lg-4">
                            <h5>Filter</h5>
                            <select class="form-control form-select-lg col-md-3 " id="selEmpAtt" style="margin-bottom:5px" >
                                ...
                                <button class="btn-sm btn btn-info mx-3 " id="btnViewAtt"> <i class="fa fa-print"></i> View</button>
                                <button class="btn-sm btn btn-info  btnprint" id="btngen1Att"> <i class="fa fa-print"></i> Print</button>
                        </div>
